...
% csvwrite('eatingVals_1503510449718_IMU_fork.csv',Y_eatingVals);
 ...
 Y_noneatingVals = vertcat(X_noneating,Y_noneating_rms, Y_noneating_std,Y_noneating_mean,Y_noneating_fft,Y_noneating_max);
 ...
 it=3
 oneUserResults=[];
 oneUserResults=vertcat(X_eating, Y_eating_rms,Y_eating_std, Y_eating_mean, Y_eating_fft, Y_eating_max,Y_noneating_rms,Y_noneating_std, Y_noneating_mean, Y_noneating_fft, Y_noneating_max);
